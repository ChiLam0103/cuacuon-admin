...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#create">Thêm chính sách bảo hành</button>
    </div>
</div>
@endcan
...
<div id="create" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.warranty_types.create') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<div id="edit" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Chinh sửa chính sách bảo hành</h4>
            </div>
            <form action="{{ route('admin.warranty_types.edit',0) }}" method="get" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $k->id }}">
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.warranty_types.destroy', $k->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
