    ...
    <div class="wrapper">
      <div class="inner text-center">
        <div class="breadcrumb-big">
          ...
          <h2>
            Máy Lọc Nước Treo Tường Rewa RW-NA-50PB1
          </h2>
        ...
        <div class="breadcrumb-small">
          ...
          <span aria-hidden="true">/</span>
          <span>Máy Lọc Nước Treo Tường Rewa RW-NA-50PB1</span>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="customize-product-slider clearfix">
              <div id="surround" class="clearfix">
                <div class="product-images" id="ProductPhoto">
                  ...
                  <img class="product-image-feature" src="./img/suplo-013a-01_master.jpg"
                       alt="Máy Lọc Nước Treo Tường Rewa RW-NA-50PB1" data-zoom-image="./img/suplo-013a-01_master.jpg">

                  <div id="sliderproduct" style="display: none !important;">
                    <ul class="slides">

                      <li class="product-thumb active">
                        <a href="javascript:" class="product__thumbnail--target-1 zoomGalleryActive"
                           data-image="./img/suplo-013a-01_master.jpg" data-zoom-image="./img/suplo-013a-01_master.jpg">
                          <img alt="Máy Lọc Nước Treo Tường Rewa RW-NA-50PB1"
                               data-image="./img/suplo-013a-01_master.jpg" src="./img/suplo-013a-01_small.jpg">
                        </a></li>

                      <li class="product-thumb">
                        <a href="javascript:" class="product__thumbnail--target-2"
                           data-image="./img/suplo-013a-02_master.jpg" data-zoom-image="./img/suplo-013a-02_master.jpg">
                          <img alt="Máy Lọc Nước Treo Tường Rewa RW-NA-50PB1"
                               data-image="./img/suplo-013a-02_master.jpg" src="./img/suplo-013a-02_small.jpg">
                        </a></li>
                  ...
                  <ul class="product-single__thumbnails inline-list" id="ProductThumbs" style="max-height: 443px;">
                    <div class="inner">
                      ...
                      <li class="thumbnail-item" data-alt="">
                        <a href="./img/suplo-013a-01_master.jpg" class="product-single__thumbnail active"
                           data-trigger="1">
                          <img src="./img/suplo-013a-01_small.jpg" alt="">
                        </a>
                      </li>

                      <li class="thumbnail-item" data-alt="">
                        <a href="./img/suplo-013a-02_master.jpg" class="product-single__thumbnail" data-trigger="2">
                          <img src="./img/suplo-013a-02_small.jpg" alt="">
                        </a>
                      </li>
                  ...
                  <div class="owl-wrapper-outer">
                    <div class="owl-wrapper" style="width: 40px; left: 0px; display: block;">
                      <div class="owl-item" style="width: 20px;">
                        <div class="item product_variant_item active" data-variant-color="Default Title" data-alt=""
                             data-image="./img/noDefaultImage6_small.gif"
                             data-feature-image="./img/noDefaultImage6_master.gif">
                          <img src="./img/noDefaultImage6_small.gif" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="grid__item large--six-twelfths medium--one-whole small--one-whole">
            <div class="product-content">
              <div class="pro-content-head clearfix">
                <h1 itemprop="name">Máy Lọc Nước Treo Tường Rewa RW-NA-50PB1</h1>
                <div class="pro-brand">
                  <span class="title">Thương hiệu:</span> <a
                    href="https://suplo-company-2.myharavan.com/collections/vendors?q=rewa&amp;view=vendor-alt">Rewa</a>
                </div>
                <span>|</span>
                <div class="pro-type">
                  <span class="title">Loại: <a
                      href="https://suplo-company-2.myharavan.com/collections/types?q=may-loc-nuoc&amp;view=type-alt">Máy lọc nước</a></span>
                </div>
                <span>|</span>
              ...
              <div class="pro-price clearfix">
                <span class="current-price ProductPrice">2,790,000₫</span>
                    ...
                    <div id="variant-swatch-0" class="swatch swatch-product-single clearfix" data-option="option1"
                      ...
                      <div class="select-swap">
                        ...
                        <div data-value="Default Title" class="n-sd swatch-element default-title">
                          <input class="variant-0 input-product" id="swatch-0-default-title" type="radio" name="option1"
                      ...
                      <div class="qty-addcart clearfix">
                        ...
                        <div class="js-qty">
                          ...
                          <input type="number" class="js-qty__num" value="1" min="1" data-id="" aria-label="quantity"
                                 pattern="[0-9]*" name="quantity" id="Quantity" onkeyup="setCurrentQuantity(this)">
          ...
          <div class="grid__item large--nine-twelfths medium--one-whole small--one-whole">
            <div class="product-description-wrapper">
              <div class="tab clearfix">
                ...
                <button class="pro-tablinks active" onclick="openProTabs(event, &#39;protab1&#39;)"
                        id="defaultOpenProTabs">Thông số kỹ thuật
                </button>
                ...
                <button class="pro-tablinks" onclick="openProTabs(event, &#39;protab3&#39;)">Chính sách bảo hành
                </button>
                    ...
                    <div class="grid__item large--one-third medium--one-quarter small--one-quarter pd-left15">
                      <div class="rsp-img">
                        <a href="https://suplo-company-2.myharavan.com/products/bo-loi-loc-cap-1-2-3-may-loc-nuoc-ro-aquafilter">
                          <img src="./img/suplo-007a-01_medium.jpg"
                               alt="Bộ Lõi Lọc Cấp 1,2,3 Máy Lọc Nước RO Aquafilter">
                        </a>
                      </div>
                    </div>
                    <div class="grid__item large--two-thirds medium--three-quarters small--three-quarters pd-left15">
