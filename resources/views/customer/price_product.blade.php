                        ...
                        <form action="{{ url('/bao-gia') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid__item large--one-whole">
                                <div class="page-contact-wrapper">
                                    ...
                                    <div class="page-head wow fadeInLeft" data-wow-duration="1.5s"
                                        data-wow-delay="0.4s">
                                        <div class="list-button">
                                            <button type="button" class="build-product" onclick="rebuildProduct()"><i
                                                    class="fa fa-recycle"></i> Build
                                                lại
                                            </button>
                                            <a href="{{url('export')}}"> <button type="button" class="build-product"><i
                                                        class="fa fa-download"></i> Tải file Excel </button></a>
                                            <button type="button" class="build-product" data-toggle="modal"
                                                data-target="#myModal2"><i class="fa fa-download"></i> Nhận tư vấn
                                            </button>
                                        </div>
                                        <div class="list-product">
                                            <div class="item">
                                                ...
                                                <div class="choose-item" id="item-1">
                                                    <button type="button" class="build-product btn-choose-product"
                                                        onclick="openChooseProductPopup(this, 1)">
                                                        Chọn sản phẩm
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="item">
                                                ...
                                                <div class="choose-item" id="item-2">
                                                    <button type="button" class="build-product btn-choose-product"
                                                        onclick="openChooseProductPopup(this, 2)">
                                                        Chọn sản phẩm
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="item">
                                                ...
                                                <div class="choose-item" id="item-3">
                                                    <button type="button" class="build-product btn-choose-product"
                                                        onclick="openChooseProductPopup(this, 3)">
                                                        Chọn sản phẩm
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="item">
                                                ...
                                                <div class="choose-item" id="item-4">
                                                    <button type="button" class="build-product btn-choose-product"
                                                        onclick="openChooseProductPopup(this, 4)">
                                                        Chọn sản phẩm
                                                    </button>
                                                </div>
                                            </div>
        ...
        <div class="choose-item-wrapper">
            ...
            <div class="choose-item-body">
                <div class="w40 item-left">
                    @foreach($brands as $k)
                    <div class="sub-item">
                        <div class="w100 sub-item-chooser" data-id="{{$k->id}}"
                            style="width:95%;background:white !important">{{$k->name}}</div>
                    </div>
                    @endforeach
                </div>
                <div class="w60 item-right">
                    ...
                    <div class="item-chosen brand_{{$k->brand_id}}">
                        ...
                        <div class="item-button w20">
                            <button type="button" class="add-to-cart-yes" data-id="{{$k->id}}"
                                onclick="addToCart({{$k->id}})">
